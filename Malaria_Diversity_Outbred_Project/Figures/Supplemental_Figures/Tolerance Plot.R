...
ggplot(OrderedPhenotypes, aes(x = Index, y = MinDeltaTemp, color = as.factor(Lived))) + geom_point() + theme_classic() + scale_color_manual(values =c("salmon","royalblue")) + theme(legend.position = "none")
s